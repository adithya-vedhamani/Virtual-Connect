...
import imp from "../src/assets/imp.jpg";
    ...
    <div className=" ">
      ...
      <div className="relative h-screen ">
        ...
        <div className="absolute h-full w-full flex overflow-hidden">
          <img src={imp} className="object-cover  w-full h-full" />
        </div>
        {/* Overlay */}
        ...
        <div className="lg:flex lg:pt-20 flex-col items-center justify-center relative z-10 px-6 md:max-w-[90vw] mx-auto">
          ...
          <div className=" flex flex-col items-center justify-center pb-8">
            ...
            <p className="text-[26px] text-white  -mt-2">Powered by ZegoCloud</p>
          </div>
          ...
          >
            ...
            <p className="text-[16px] text-white  -mt-2">[ Enter Random Number and Share it with others to join the meeting ]</p>
          </div>
            <button
              type="submit"
